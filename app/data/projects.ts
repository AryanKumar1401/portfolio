...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: 'Developed a machine learning model to predict MBTI personality types based on text data, leveraging NLP techniques and algorithms like Logistic Regression and Naive Bayes for classification.',
